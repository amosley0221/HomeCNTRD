...
// Tesla's public configurator compositor. Uses a 3-quarter view since
// it's the cleanest "studio" angle on a dark background. Note: Tesla's
// compositor sometimes drops the wheels for older Model 3 option combos
// — there's no reliable workaround for that since the asset just isn't
// returned. Drop a /local/homecntrd-tesla.jpg if you want a perfect
// photo.
